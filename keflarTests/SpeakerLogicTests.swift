...
struct SpeakerLogicTests {
    ...
    @Test func parseCurrentSongWithTrackIdContextAndResources() {
        let playerData: [String: Any] = [
            "status": ["duration": 180000] as [String: Any],
            "trackRoles": [
                "id": "airable://tidal/track/150850051",
                "title": "Down in the Past",
                "quality": ["low", "high", "lossless"] as [String],
                "context": ["path": "airable:context:"] as [String: Any],
                "mediaData": [
                    "metaData": ["artist": "Artist", "serviceID": "tidal"] as [String: Any],
                    "resources": [
                        ["mimeType": "audio/flac", "codec": "FLAC", "bitRate": 1411000, "uri": "https://proxy.airable.io/tidal/play/flac/1411/150850051"] as [String: Any],
                        ["mimeType": "audio/mp4", "codec": "AAC", "bitRate": 320000, "uri": "https://proxy.airable.io/tidal/play/aac/320/150850051"] as [String: Any],
                    ] as [[String: Any]],
                ] as [String: Any],
            ] as [String: Any],
        ]
        let song = parseCurrentSong(from: playerData)
        #expect(song.trackId == "150850051")
        #expect(song.contextPath?.hasPrefix("airable:context:") == true)
        #expect(song.availableQualities == ["low", "high", "lossless"])
        #expect(song.resources?.count == 2)
        #expect(song.resources?[0].codec == "FLAC")
        #expect(song.resources?[0].bitRate == 1411000)
        #expect(song.resources?[1].codec == "AAC")
    }

    @Test func parseCurrentSongDeezerWithImagesFallback() {
        let playerData: [String: Any] = [
            "status": ["duration": 198000] as [String: Any],
            "trackRoles": [
                "id": "airable://deezer/track/2005372617",
                "title": "Jump Sit Stand March",
                "images": [
                    "images": [
                        ["url": "https://cdn-images.dzcdn.net/images/cover/a1fe43756052bbb81cc19914836f5e07/500x500-000000-80-0-0.jpg", "height": 500, "width": 500] as [String: Any],
                    ] as [[String: Any]],
                ] as [String: Any],
                "mediaData": [
                    "metaData": [
        ...
        let song = parseCurrentSong(from: playerData)
        #expect(song.serviceID == "deezer")
        #expect(song.trackId == "2005372617")
        #expect(song.title == "Jump Sit Stand March")
        #expect(song.artist == "Jack Kays")
        #expect(song.album == "CESSATION")
        #expect(song.duration == 198000)
        #expect(song.coverURL == "https://cdn-images.dzcdn.net/images/cover/a1fe43756052bbb81cc19914836f5e07/500x500-000000-80-0-0.jpg")
    }
    ...
    @Test func resolveTrackFromRowValueDeezerTrack() {
        let row: [String: Any] = [
            "value": ["path": "airable:https://x.airable.io/id/deezer/track/456", "title": "Deezer Track"] as [String: Any],
        ]
        let track = resolveTrackFromRow(row)
        #expect(track != nil)
        #expect(track?["title"] as? String == "Deezer Track")
        #expect((track?["path"] as? String)?.contains("/deezer/track") == true)
    }
    ...
    @Test func parseCurrentSongWithDeezerServiceID() {
        let playerData: [String: Any] = [
            "trackRoles": [
                "title": "Song Title",
                "id": "airable:https://x.airable.io/id/deezer/track/789",
                "mediaData": [
                    "metaData": ["serviceID": "deezer", "artist": "Artist", "album": "Album"] as [String: Any],
                ] as [String: Any],
            ] as [String: Any],
            "status": ["duration": 180000] as [String: Any],
        ]
