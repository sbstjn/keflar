...
public enum SpeakerConnectError: Error {
    ...
    /// Streaming service not configured in ServiceRegistry.
...
extension SpeakerConnectError: LocalizedError {
    public var errorDescription: String? {
        ...
        case .serviceNotConfigured(let service):
            return "Streaming service '\(service)' not configured. Enable it in ConnectionConfig.services."
        }
    }
    ...
    public var recoverySuggestion: String? {
        ...
        case .serviceNotConfigured(let service):
            return "Add .\(service) to ConnectionConfig.services when connecting."
        }
    }
}
